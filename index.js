...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5511934488829@s.whatsapp.net","5521996562452@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5511934488829@s.whatsapp.net","5521996562452.whatsapp.net"]//ubah nomor lo
...
const get = require('got')
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bom dia")){
			...
			if (messagesC.includes("minatobot")){
			client.updatePresence(from, Presence.composing)
			reply("oiii")
	}
